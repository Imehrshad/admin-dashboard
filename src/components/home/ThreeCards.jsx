  ...
  return (
    <>
      ...
      >
        ...
        <h1 className="lg:text-3xl md:text-base text-3xl ">3250</h1>
      </motion.div>
      <motion.div
      ...
      >
        ...
        <h1 className="lg:text-3xl md:text-base text-3xl ">2011</h1>
      </motion.div>
      <motion.div
        initial={{ opacity: 0, x: -100 }}
        animate={{ opacity: 1, x: 0 }}
      ...
      >
        ...
        <h1 className="lg:text-3xl md:text-base text-3xl ">1230450</h1>
      </motion.div>
    </>
  );
};
